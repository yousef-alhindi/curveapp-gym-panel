...
export class ApiService {
  ...
  post(url: any, data: any): Observable<any> {
    return this.http.post(
      `${this.baseUrl}/api/v1/gym/auth/${url}`,
      data
    );
  }

  put(url: any, data: any): Observable<any> {
    return this.http.put(`${this.baseUrl}/api/v1/gym/auth/${url}`, data);
  }
  ...
  delete1(url: any): Observable<any> {
    return this.http.delete(`${this.baseUrl}/api/v1/gym/${url}`);
  }
  ...
  get(url: any): Observable<any> {
    return this.http.get(`${this.baseUrl}/api/v1/gym/auth/${url}`);
  }
  patch1(url: any,data:any): Observable<any> {
    return this.http.patch(`${this.baseUrl}/api/v1/gym/${url}`,data);
  }
  get1(url: any): Observable<any> {
    return this.http.get(`${this.baseUrl}/api/v1/gym/${url}`);
  }
 
  post1(url: any, data: any): Observable<any> {
    return this.http.post(`${this.baseUrl}/api/v1/gym/${url}`, data);
  }
  put1(url: any, data: any): Observable<any> {
    return this.http.put(`${this.baseUrl}/api/v1/gym/${url}`, data);
  }
