...
export class FoodRestaurantComponent {
  ...
  private updateActivatedModuleName() {
    ...
    if (decodedUrl === '/gym/menu-mgmt') {
    ...
    else if (decodedUrl.includes('gym-package-mgmt')) {
      this.activatedModuleName = 'Gym Package Management';
    }
      ...
      this.activatedModuleName = 'View Support Tickets';
    }
