...
import { DescriptonComponent } from './support-tickets/descripton/descripton.component';
import { GymPackageMgmtComponent } from './gym-package-mgmt/gym-package-mgmt.component';
import { DescriptionComponent } from './gym-package-mgmt/description/description.component';
import { DurationComponent } from './gym-package-mgmt/duration/duration.component';
...
@NgModule({
  declarations: [
    ...
    CreateSupportTicketsComponent,
    DescriptonComponent,
    GymPackageMgmtComponent,
